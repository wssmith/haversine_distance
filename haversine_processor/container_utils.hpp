...
#define FORWARD_ITERATOR_SUPPORT(container) \
...
#define REVERSE_ITERATOR_SUPPORT(container) \
...
FORWARD_ITERATOR_SUPPORT(container) \
REVERSE_ITERATOR_SUPPORT(container)
